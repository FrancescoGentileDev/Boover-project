      ...
      <div class="w-full px-5 rounded-xl">
        ...
        <div class="rounded-xl bg-base-100 overflow-hidden shadow-xl">
          ...
          <div
            ...
            "
          >
            <div class="avatar online translate-y-1/2 translate-x-8">
              <div
                class="
                  w-32
                  rounded-full
                  ring ring-white ring-offset-base-100 ring-offset-2
                "
              >
                <img
        ...
        <div class="rounded-xl bg-base-100 overflow-hidden shadow-xl p-8 my-4">
        ...
        <!-- reviews container-->
        <div class="">
          <h1 class="font-bold text-2xl px-5 pt-4">Le mie recensioni</h1>
          ...
          >
            <div class="flex items-center">
              ...
              <h3 class="mx-2 text-sm">
                <span v-if="review.vote > 1">{{ review.vote }} stelle</span>
      ...
      <div class="w-full px-5 pt-10 lg:w-3/5 lg:pt-0">
        <div class="shadow-xl rounded-xl bg-base-200">
          <div class="p-8 mx-auto rounded-lg">
            ...
            >
              <h1 class="text-2xl font-bold py-4">Lascia un messaggio</h1>

              <div class="flex-1">
                <label class="block mb-2 text-sm text-base-content">Nome</label>
                <input
                  type="text"
                  required
              ...
              <div class="flex-1 mt-6">
                <label class="block mb-2 text-sm text-base-content"
                  >Email</label
                >
                <input
                  type="email"
              ...
              <h1 v-if="isMessageSent" class="text-center text-accent py-4">
                Messaggio inviato!
              </h1>
              <button
                v-else
            ...
            <!-- review form -->
            <form ref="formReview" class="mt-6" @submit="submitReview" v-else>
              <h1 class="text-2xl font-bold py-4">Lascia una recensione</h1>
              ...
              <div class="flex-1 mt-14">
                <label class="block mb-2 text-sm text-base-content">Voto</label>
                <input
                  type="number"
                  min="1"
                  max="5"
              ...
              <h1 v-if="isReviewSent" class="text-center text-accent py-4">
                Recensione inviata!
              </h1>
...
export default {
  ...
  computed: {
    ...
    //
    computedObj() {
        let limitedReviews = this.reviews;
        let newLimit = limitedReviews.slice(0, this.limitReviews);
        return newLimit;
    },
  },
  //
  ...
  methods: {
    ...
    getUserCorrelated(id) {
      axios.get(`/api/users/?skill=${id}`).then((response) => {
        ...
        console.log("Debug - Current correlated users", this.correlatedUsers);
      });
    },
    //
