  ...
  <div class="flex flex-row justify-center my-5">
    ...
    >
      <img
        ...
        src="http://puu.sh/Ju5yD/e18b42ec21.jpg"
        alt="avatar"
      />
      ...
      <div class="flex items-center px-6 py-3 bg-gray-900">
        ...
        <h1 class="mx-3 text-lg font-semibold text-white">Coding</h1>
      </div>
      ...
      <div class="px-6 py-4">
        ...
        <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
          ...
          <h1 class="px-2 text-sm">Boolean</h1>
        </div>
        ...
        <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
          ...
          <h1 class="px-2 text-sm">Italia</h1>
        </div>
        ...
        <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
          ...
          <h1 class="px-2 text-sm">valerio.dev@example.com</h1>
        </div>
      </div>
    </div>
  </div>
