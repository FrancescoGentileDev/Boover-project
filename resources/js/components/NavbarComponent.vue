<template>
    <div class="fixed w-full shadow-sm z-50" ref="inside">
        <!-- Require css -->
        <div class=" nav0 nav0-sfondo relative z-[70] transition-all">
            <nav
                ref="nav"
            ...
            >
                <div
                    ...
                    :class="
                        scrollY > 0 ? 'md:justify-center' : 'md:justify-start'
                    "
                >
                ...
                >
                    <router-link
                        to="/ourteam"
                        class="hidden md:inline nav0 nav0-text"
                        >il team</router-link
                    >
                    <a class="btn btn-primary m-3" href="/login"> Accedi </a>
                    <a
                        class="btn btn-outline m-3 nav0 nav0-text"
                        href="/register"
                    >
                        Registrati
                    </a>
                ...
                <transition name="sidebar">
                    <div
                        class="sidebar absolute h-screen w-56 bg-base-200 top-0 left-0 z-30 p-3 overflow-y-auto"
                        v-if="ShowSidebar"
                    >
        ...
        <div
            class="border-t-2 z-50"
            :hidden="scrollY <= 0 && !showOnZero"
        ></div>

        <transition name="categoryLine">
            <div
                class="absolute w-full bg-base-200 z-[60]"
                v-if="scrollY > 400 || categoriesOnZero ? true : false"
            >
                <div
                    ref="categoryLine"
                    class="py-2 categoryLine container hidden sm:block mx-auto relative"
                >
                    <div
                        id="drops"
                        ref="drops"
...
.categoryLine-enter-active,
.categoryLine-leave-active {
    transition: transform 0.5s;
    transform: opacity 0.2s;
    transform: translateY(0px);
}
.categoryLine-enter,
.categoryLine-leave-to {
    opacity: 0;
