    ...
    <div class="fixed w-full nav0 nav0-sfondo shadow-sm z-50" ref="inside">
        ...
        >
            ...
            >
                <router-link
                    to="/ourteam"
                    class="btn btn-warning bg-yellow-300 flex flex-row items-center justify-center mr-3 md:inline nav0 nav0-text"
                    style="
                        color: purple;
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <ul
                        tabindex="0"
                        class="dropdown-content top-5 menu p-2 shadow bg-base-100 rounded-md w-auto"
                        :class="{
                            'right-0':
