...
@section('content')
        ...
        <section class="body-font overflow-hidden">
            <div class="container px-5 py-24 mx-auto">
                <div class="flex flex-col text-center w-full">
                    <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 base-100">Hai una sponsorship attiva!
                    </h1>
                    <p class="lg:w-2/3 mx-auto leading-relaxed text-base base-200">Al momento sei un utente sponsorizzato.
                        Godi dei tuoi vantaggi esclusivi per tutta la durata del boost!</p>
                </div>
            </div>
    ...
    @elseif (!$isUserSponsorized)
        ...
        <section class="body-font overflow-hidden">
            <div class="container px-5 py-24 mx-auto">
                <div class="flex flex-col text-center w-full">
                    <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 base-100">Sponsorizzazioni</h1>
                    <p class="lg:w-2/3 mx-auto leading-relaxed text-base base-100">Acquista un badge sponsorizzato per
                        farti notare in mezzo a tanti e dare un boost al tuo profilo. Sponsorizzando il tuo profilo
                        comparirai al primo posto nei risultati di ricerca e avrai accesso alla speciale sezione Freelance
                        in evidenza. </p>
                </div>
            </div>
